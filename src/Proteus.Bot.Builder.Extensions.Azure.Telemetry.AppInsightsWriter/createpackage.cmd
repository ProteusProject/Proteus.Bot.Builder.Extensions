...
..\..\packages\NuGet.CommandLine.4.5.1\tools\NuGet.exe pack Proteus.Bot.Builder.Extensions.Azure.Telemetry.AppInsightsWriter.nuspec -symbols -properties version=%version%;telemetry=%telemetry% -OutputDirectory ..\..\nuget
