...
..\..\packages\NuGet.CommandLine.4.3.0\tools\NuGet.exe pack Proteus.Bot.Builder.Extensions.Telemetry.nuspec -symbols -properties version=%version%;builder=%builder% -OutputDirectory ..\..\nuget
