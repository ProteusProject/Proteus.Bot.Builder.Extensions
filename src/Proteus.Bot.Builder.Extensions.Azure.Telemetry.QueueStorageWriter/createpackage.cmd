...
..\..\packages\NuGet.CommandLine.4.3.0\tools\NuGet.exe pack Proteus.Bot.Builder.Extensions.Azure.Telemetry.QueueStorageWriter.nuspec -symbols -properties version=%version%;telemetry=%telemetry% -OutputDirectory ..\..\nuget
